...
//implements serializable because goes from being a java class into a data stream that will be saved in the DB
@Entity //converts User into a table in the database
